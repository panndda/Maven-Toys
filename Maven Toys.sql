...
--1a. Product category with highest profit
SELECT
    product_category,
...
--2a. how much money is tied up in inventory at the toy stores?
...
--3. Are sales been lost at certain locations due to out of stock products?
SELECT
    s.store_location,
    s.store_name,
    p.product_name,
...
--6. Which store has the highest inventory turnover rate?
WITH unit_sold AS (
    SELECT
        store_id,
        SUM(units) AS unit
